...
| Research | `Copilot` | **94% verified** | Checkpoints 1-5 now provide the shared run/transcript/session/artifact foundation, productionized Operator authority, versioned and budgeted context contracts, deterministic fingerprints and compaction, visible domain-selection/omission reasons, first-class Sealanes/news context, and complete IV/Commodities/Equity Research drilldowns. Next: Checkpoint 6 shelf continuity, model policy, retention, and diagnostics; then the Checkpoint 7 release gate. |
...
_Status: In progress (94%; checkpoints 1-5 verified)_
...
- `Dedicated workspace`: ~94% complete. The typed chat/session/artifact and Operator confirmation foundation now includes replayable versioned context contracts, selected/omitted-domain explanations, deterministic compaction disclosures, and source navigation for the Checkpoint 5 domains. Remaining workspace work belongs to Checkpoints 6 and 7.
...
| --- | ---: | --- | --- |
| Current verified baseline | **94%** | Checkpoints 1-5: the shared run/transcript/session/artifact and Operator-authority foundation plus versioned context contracts, deterministic fingerprinting/compaction/invalidation, visible domain routing, first-class Sealanes/news context, and priority IV/Commodities/Equity Research drilldowns. | Checkpoint 5 passed 209 focused backend tests, the full 461-test backend suite, 315 frontend tests, typecheck, production build, desktop check, and 22/22 deterministic representative eval outcomes. Provider absence, degradation, budget omission, replay, evidence validation, navigation, permission, and unchanged Checkpoint 4 confirmation invariants are covered. |
