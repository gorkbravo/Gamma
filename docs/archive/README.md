...
These documents are preserved for project history and transition traceability.

They are not the primary source of truth for current development.
...
Dated usability, codebase, provider, and frontend audits now live under [`../audits/`](../audits/README.md).

For current setup and runtime guidance, use [`../../README.md`](../../README.md).
For current product direction, use [`../../roadmap.md`](../../roadmap.md).
