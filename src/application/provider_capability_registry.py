...
_ACTIVE_PROVIDER_CAPABILITIES: tuple[ProviderCapability, ...] = (
    ...
    _capability(
        ...
        status="sample",
        supported_domains=["portfolio", "research", "risk", "iv", "maritime_intelligence", "copilot", "tests"],
        asset_classes=["equities", "portfolio", "fx", "options", "synthetic_data", "ais", "vessels", "maritime"],
        ...
        limitations=[
            ...
            "Synthetic IV, sample maritime positions, and mock Copilot outputs are generated for offline development and smoke testing.",
        ],
        provenance_notes=[
