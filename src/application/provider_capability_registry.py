...
_ACTIVE_PROVIDER_CAPABILITIES: tuple[ProviderCapability, ...] = (
    ...
    _capability(
        ...
        status="sample",
        supported_domains=["portfolio", "research", "risk", "iv", "commodities", "maritime_intelligence", "copilot", "tests"],
        asset_classes=[
            "equities",
            "portfolio",
            "fx",
        ...
        limitations=[
            ...
            "Synthetic IV, sample commodities, sample maritime positions, and mock Copilot outputs are generated for offline development and smoke testing.",
        ],
        provenance_notes=[
